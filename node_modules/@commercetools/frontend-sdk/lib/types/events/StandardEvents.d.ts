import { ActionError } from '../../library/ActionError.js';
import { PageError } from '../../library/PageError.js';
...
type StandardEvents = {
    ...
    productCategoriesQueried: {
        query: unknown;
        result: unknown;
    };
    searchableProductAttributesFetched: {
    ...
    availableShippingMethodsFetched: {
        shippingMethods: unknown[];
    };
    ...
    lineItemAddedToWishlist: {
        lineItem: unknown;
    };
    lineItemRemovedFromWishlist: {
        lineItemId: string;
    };
    wishlistLineItemUpdated: {
        lineItem: unknown;
    };
    errorCaught: {
